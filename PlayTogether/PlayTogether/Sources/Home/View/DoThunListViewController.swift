...
class DoThunListViewController: BaseViewController {
    ...
    private var viewModel = DoThunListViewModel()
    ...
    private func getThunData(_ sort: String) {
        ...
        self.viewModel.fetchThunList(pageSize: self.viewModel.maxSize, curpage: self.viewModel.currentPageCount, category: "할래", sort: sort) { response in
