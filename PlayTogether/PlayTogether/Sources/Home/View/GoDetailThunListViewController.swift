...
final class GoDetailThunListViewController: BaseViewController {
    ...
    private let superViewModel: GoThunListViewModel?
    var lightId: Int?
    var imageCount: Int?
    
    init(lightID: Int, superViewModel: GoThunListViewModel) {
...
extension GoDetailThunListViewController {
    func setupData(
        _ title: String,
        _ date: String,
        _ time: String,
...
extension GoDetailThunListViewController: OneButtonDelegate, TwoButtonDelegate {
